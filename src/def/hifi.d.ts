...
declare class Signal<F = Function> {
    ...
    connect(scope: object, callback: string): void;
    disconnect(callback: F): void;
    disconnect(scope: object, callback: string): void;
}
...
declare class MyAvatar {
    ...
    static audioListenerMode: number;
    static audioListenerModeHead: number = 0;
    static audioListenerModeCamera: number = 2;
    static audioListenerModeCustom: number = 3;
...
declare class Controller {
    ...
    static enableMapping(mappingName: string): void;
...
declare namespace Controller {
    ...
    class Hardware {
        static GamePad: Array<any>
        static Spacemouse: Array<any>
    }
    class Standard {
        Standard: number;
    }
...
declare namespace HMD {
    ...
    function displayModeChanged(): Signal;
...
declare class Entities {
    ...
    static addEntity(properties: any, clientOnly: boolean): Uuid;
...
declare class Graphics {
    ...
    static MaterialLayer = class {
        material: Graphics.Material;
        priority: number;
    }
    static IFSData = class {
        name: string;
        topology: string;
...
declare class Quat {
    ...
    z: number;
    w: number;
    static multiply(q1: Quat, q2: Quat): Quat;
    static normalize(q: Quat): Quat;
    static conjugate(q: Quat): Quat;
    static lookAt(eye: Vec3, target: Vec3, up: Vec3): Quat;
    static lookAtSimple(eye: Vec3, target: Vec3): Quat;
    static rotationBetween(v1: Vec3, v2: Vec3): Quat;
    static fromVec3Degrees(vector: Vec3): Quat;
    static fromVec3Radians(vector: Vec3): Quat;
    static fromPitchYawRollDegrees(pitch: number, yaw: number, roll: number): Quat;
    static fromPitchYawRollRadians(pitch: number, yaw: number, roll: number): Quat;
    static inverse(q: Quat): Quat;
    static getFront(orientation: Quat): Vec3;
    static getForward(orientation: Quat): Vec3;
    static getRight(orientation: Quat): Vec3;
    static getUp(orientation: Quat): Vec3;
    static safeEulerAngles(orientation: Quat): Vec3;
    static angleAxis(angle: number, axis: Vec3): Quat;
    static axis(q: Quat): Vec3;
    static angle(q: Quat): number;
    static mix(q1: Quat, q2: Quat, alpha: number): Quat;
    static slerp(q1: Quat, q2: Quat, alpha: number): Quat;
    static squad(q1: Quat, q2: Quat, s1: Quat, s2: Quat, alpha: number): Quat;
    static dot(q1: Quat, q2: Quat): number;
    static print(label: string, q: Quat, asDegrees: boolean): void;
    static equal(q1: Quat, q2: Quat): boolean;
    static cancelOutRollAndPitch(orientation: Quat): Quat;
    static cancelOutRoll(orientation: Quat): Quat;
...
declare class Uuid {
    ...
    static isEqual(idA: Uuid, idB: Uuid): boolean;
    static isNull(id: Uuid): boolean;
    static print(label: string, id: Uuid): void;
    static readonly NULL: Uuid;
}
...
declare class Vec3 {
    ...
    static multiply(v: Vec3, scale: number): Vec3;
    static multiply(scale: number, v: Vec3): Vec3;
    static multiplyVbyV(v1: Vec3, v2: Vec3): Vec3;
    ...
    static orientedAngle(v1: Vec3, v2: Vec3, ref: Vec3): number;
    static normalize(v: Vec3): Vec3;
    static mix(v1: Vec3, v2: Vec3, factor: number): Vec3;
    static print(label: string, v: Vec3): void;
    static equal(v1: Vec3, v2: Vec3): boolean;
    static withinEpsilon(v1: Vec3, v2: Vec3, epsilon: number): boolean;
    static toPolar(p: Vec3): Vec3;
    static fromPolar(polar: Vec3): Vec3;
    static fromPolar(elevation: number, azimuth: number): Vec3;
